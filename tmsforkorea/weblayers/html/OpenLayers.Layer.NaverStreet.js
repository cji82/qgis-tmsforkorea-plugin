...
OpenLayers.Layer.NaverStreet = OpenLayers.Class(OpenLayers.Layer.XYZ, {
  
    name: "NaverStreetMap",
    url: [
    "https://map.pstatic.net/nrb/styles/basic/1778232861/${z}/${x}/${y}.jpg"
    ],
  ...
  maxExtent: new OpenLayers.Bounds(90112, 1192896, 1990673, 2761664),
    ...
    clone: function(obj) {
        if (obj == null) {
            obj = new OpenLayers.Layer.NaverStreet(
  ...
  CLASS_NAME: "OpenLayers.Layer.NaverStreet"
});
