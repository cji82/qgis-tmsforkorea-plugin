...
OpenLayers.Layer.NaverHybrid = OpenLayers.Class(OpenLayers.Layer.XYZ, {
  
    name: "NaverHybridMap",
    url: [
    "https://map.pstatic.net/nrb/styles/satellite/1778232861/${z}/${x}/${y}.jpg?mt=bg.ol.ts.lko"
    ],
  ...
  maxExtent: new OpenLayers.Bounds(90112, 1192896, 1990673, 2761664),
    ...
    clone: function(obj) {
        if (obj == null) {
            obj = new OpenLayers.Layer.NaverHybrid(
  ...
  CLASS_NAME: "OpenLayers.Layer.NaverHybrid"
});
